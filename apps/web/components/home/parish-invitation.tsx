      ...
      <div className="container-sacred relative">
        ...
        <ScrollReveal animation="fade-in-up">
          <div className="mx-auto mb-16 max-w-3xl text-center">
            ...
            <p
              className="mt-2 text-base font-bold text-slate-700 dark:text-slate-300"
              lang="ta"
        ...
        <div className="mx-auto mb-16 grid max-w-5xl gap-8 sm:grid-cols-2">
          {WAYS.map(({ icon: Icon, title, titleTa, desc, descTa, href, label, style }, i) => (
            <ScrollReveal key={title} animation="fade-in-up" delay={i * 80}>
              <Link
                href={href}
                className="hover:border-primary group flex h-full flex-col gap-5 rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-lg transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl md:p-9 dark:border-slate-800 dark:bg-slate-900"
              >
                {/* Icon */}
                <div
                ...
                <div className="flex-1">
                  ...
                  <p
                    className="mb-3 text-sm font-bold text-primary dark:text-gold-400"
                    lang="ta"
                    style={{ fontFamily: "'Noto Sans Tamil', sans-serif" }}
                  >
                    {titleTa}
                  </p>
                  <p className="text-sm font-medium leading-relaxed text-slate-800 dark:text-slate-200 md:text-base">
                    {desc}
                  </p>
                  <p
                    className="mt-2 text-xs font-semibold leading-relaxed text-slate-700 dark:text-slate-300 md:text-sm"
                    lang="ta"
                    style={{ fontFamily: "'Noto Sans Tamil', sans-serif" }}
                  >
                    {descTa}
                ...
                {/* CTA arrow */}
                <div className="text-primary dark:text-gold-400 flex items-center gap-2 text-sm font-black">
