...
import { GraduationCap, Clock, Sparkles, ArrowLeft, PhoneCall, Mail } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
              We are currently digitizing the official parish sacramental registers (Baptism, First Holy Communion, Confirmation, and Marriage records). The online certificate requesting & digital verification feature will be launched soon!
            </p>
          </div>

          {/* Upcoming Features Pills */}
          <div className="pt-4 grid grid-cols-2 md:grid-cols-4 gap-3 text-xs font-bold text-foreground">
            <div className="rounded-2xl border border-border/80 bg-muted/40 p-3 shadow-sm">
              📜 Baptism Certificates
            </div>
            <div className="rounded-2xl border border-border/80 bg-muted/40 p-3 shadow-sm">
              🕊️ Confirmation Records
            </div>
            <div className="rounded-2xl border border-border/80 bg-muted/40 p-3 shadow-sm">
              💍 Marriage Extract
            </div>
            <div className="rounded-2xl border border-border/80 bg-muted/40 p-3 shadow-sm">
              ✝️ Family Parish Records
            </div>
          </div>

          {/* Offline Instructions Box */}
          <div className="mt-8 rounded-2xl border border-primary/30 bg-primary/5 p-6 text-left text-xs space-y-2">
            <div className="flex items-center gap-2 font-bold text-foreground text-sm">
              <Sparkles className="h-4 w-4 text-primary" /> Need a certificate urgently in the interim?
            </div>
            <p className="text-muted-foreground">
              Please visit the <strong>Parish Office</strong> in person from Sunday to Saturday (09:00 AM – 01:00 PM & 05:00 PM – 08:30 PM) or contact our parish administrator directly.
            </p>
