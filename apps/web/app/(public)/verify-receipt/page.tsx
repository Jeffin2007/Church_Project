...
export default function VerifyReceiptPage({ _searchParams }: { _searchParams: { hash?: string } }) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ fontWeight: 'bold', color: '#8b6b23' }}>{verification.receiptType}</span>
          </div>
          ...
          >
            ...
            <span style={{ fontWeight: 600, color: '#1e293b' }}>{verification.receiptDate}</span>
          </div>
